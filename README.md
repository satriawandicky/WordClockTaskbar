...
[![Download Windows x64](https://img.shields.io/badge/download-Windows%20x64-blue)](https://github.com/satriawandicky/WordClockTaskbar/releases/download/v1.0.4/WordClockTaskbar-v1.0.4-win-x64.exe)

**Latest download:** [WordClockTaskbar-v1.0.4-win-x64.exe](https://github.com/satriawandicky/WordClockTaskbar/releases/download/v1.0.4/WordClockTaskbar-v1.0.4-win-x64.exe)<br>
...
1. **Download the latest Windows x64 executable:**
   [WordClockTaskbar-v1.0.4-win-x64.exe](https://github.com/satriawandicky/WordClockTaskbar/releases/download/v1.0.4/WordClockTaskbar-v1.0.4-win-x64.exe)
